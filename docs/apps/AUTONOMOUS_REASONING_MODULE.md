...
- `services/reasoning/types.py` _(path unverified after split)_

Expected behavior:

- the Infinity orchestrator gathers context and calls a reusable reasoning engine
- `apps/analytics/services/orchestration/infinity_loop.py` becomes primarily loop execution, cooldown, and persistence orchestration
